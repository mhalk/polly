...
; It is a copy of the test case 'reference-argument-from-non-affine-region',
; adapted for the LLVM OpenMP backend.

; IR: call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call
; IR: call void @__kmpc_for_static_init_{{[4|8]}}
